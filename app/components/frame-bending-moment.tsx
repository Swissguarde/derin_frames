...
export default function FrameBendingMomentDiagram({
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 mb-6 flex items-center gap-2">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
      ...
      <motion.div
        ...
        className="relative backdrop-blur-md bg-gradient-to-b from-white/5 to-white/10 p-8 rounded-2xl shadow-lg border border-purple-500/20"
      >
